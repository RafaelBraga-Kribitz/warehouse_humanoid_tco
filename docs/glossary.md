...
| Episode | Episode | Episódio | Single continuous recording of robot executing a task. Unit of analysis in Module 1. |
...
| Kollektivvertrag (KV) | Kollektivvertrag | Convenção Coletiva | Austrian sector-wide collective wage agreement. Source of labor cost inputs. |
...
| NPV | Kapitalwert (KW) | VPL (Valor Presente Líquido) | Net Present Value. Primary TCO decision metric in Module 3. |
| Opex | Betriebsausgaben | Opex | Operating expenditure. Recurring costs (labor, energy, maintenance). |
...
| SSOT | Einzige Informationsquelle | FÚVF (Fonte Única da Verdade) | Single Source of Truth. This project's PROJECT_CHARTER.md. |
| Stingray | Stingray | Stingray | TGW shuttle-based warehouse architecture. Stub config in v1.0; full calibration v1.1. |
| TCO | Gesamtbetriebskosten (GBK) | TCO (Custo Total de Propriedade) | Total Cost of Ownership. The primary financial deliverable of Module 3. |
| Teleoperation | Fernsteuerung | Teleoperação | Remote operation of a robot by a human pilot. UnifoLM-WBT is teleoperared data. |
| UnifoLM-WBT | UnifoLM-WBT | UnifoLM-WBT | Unitree open whole-body teleoperation dataset for humanoid robots. Primary data source. |
