...
from `exports/tableau_public/tco_scenarios.csv`: S-lean-human is cheapest, and
S-future-2028 is the least-cost robot-inclusive option. After F-237, Monte Carlo
includes S-lean-human and assigns it 100% rank probability across the CRN sample.
...
F-237 pick-lines scaling, the published MC report includes the fair lean-human
comparator and is the ranking evidence for H4.

## Pair matrix

| Pair | Base-case decision | Interpretation |
|---|---|---|
| S-lean-human vs any robot option | S-lean-human | Cheapest ρ-feasible crew at modeled demand |
| S-future-2028 vs S-pure-humanoid | S-future-2028 | Better robot-inclusive cost due to lower effective unit need |
...
S-future-2028 minus S-lean-human five-year NPV cost across capex × wage and
...
grid-bound result explicitly: no S-future-2028 tie with S-lean-human occurs
