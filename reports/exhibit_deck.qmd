...
lean = rows["S-lean-hybrid-amr"]["npv_eur"]
future = rows["S-future-2028"]["npv_eur"]
```

## Deploy lean-human+AMR now; defer humanoid procurement

S-lean-hybrid-amr costs €453K over five years and is the lowest-cost feasible
scenario (1 human + 3 AMRs from the demand frontier). The least-cost
humanoid-inclusive case, S-future-2028, costs €2.533M and remains above the
human baseline.
...
## Robot ranking: S-future-2028 leads humanoids, but does not win overall

```{python}
#| echo: false
f"Humanoid leader: S-future-2028 ({future:,.0f} EUR NPV); lean hybrid: {lean:,.0f} EUR."
```
